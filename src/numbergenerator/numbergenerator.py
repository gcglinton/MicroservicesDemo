...
class NumberGeneratorMicroservice:
    def __init__(self):
        ...
        self.numbers_min = float(os.environ.get('NUMBERS_MIN', 3))
        self.numbers_max = float(os.environ.get('NUMBERS_MAX', 10))
        self.count_min = os.environ.get('COUNT_MIN', 1000)
        self.count_max = os.environ.get('COUNT_MAX', 100000)
