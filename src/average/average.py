...
class AverageMicroservice:
    def __init__(self):
        ...
        self.consumer_config = {
            ...
            'group.id': f'{self.stage}.average_microservice-consumer',
            'client.id': f'{self.stage}.average_microservice-consumer',
        }

        self.producer = None
        self.producer_config = {
            'bootstrap.servers': self.bootstrap_servers,
            'client.id': f'{self.stage}.average_microservice-producer',
        }
